...
namespace BLL
{
    public class VideoConverter : IVideoConverter
    {
        ...
        public void ProcessPicture(string pathPicture)
        {
            ...
            if (pathPicture != null)
            {
               ...
               // Thread.CurrentThread.Name = "ProcessPicture_" + VideoName+"_"+fileName;
                Directory.CreateDirectory("resultat\\visages\\" + VideoName);
                ...
                var faces = new CascadeClassifier(XML_LOCATION).DetectMultiScale(normalizedMasterImage, 1.1, 1, System.Drawing.Size.Empty);
                ...
                foreach (var face in faces)
                {
                    ...
                    try
                    {
                        ...
                        target.Save("resultat\\visages\\" + VideoName + "\\" + fileName);
                        target.Dispose();
                    }
                    catch (Exception e)
                    {
                ...
                {
                    middleWare.Report("resultat\\visages\\" + VideoName + "\\" + fileName);
                }
            }
        }
        public void Pause()
